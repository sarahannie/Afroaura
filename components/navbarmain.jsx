  ...
  return (
    <>
      ...
      <header className={`border-b-1 relative z-20 w-full border-b border-slate-200 bg-white/90 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden `}>
        <div className={`relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem] ${style.nav}`}>
          <nav
            aria-label="main navigation"
            className={`flex h-[2.5rem] items-stretch justify-between font-medium text-slate-700 `}
            role="navigation"
          >
            {/*      <!-- Brand logo --> */}
            <a
              ...
              aria-current="page"
              className="flex items-center gap-2 whitespace-nowrap py-3 text-lg focus:outline-none lg:flex-1 italic #D1E4FC"
              href="javascript:void(0)"
            >
              ...Where Fashion Speaks
            ...
            >
              <li role="none" className="flex items-stretch">
                <a
                  role="menuitem"
                  aria-haspopup="false"
                  className="flex items-center lg:text-black text-white gap-2 py-4 transition-colors duration-300 hover:text-blue-600 focus:bg-emerald-50 focus:outline-none focus-visible:outline-none lg:px-8"
                  href="#"
                >
                  <span>Shop</span>
                </a>
